...
from tx_agent import RNNQN, RNNQNAgent
...
if __name__ == '__main__':
    ...
    for run in range(num_runs):
        ...
        num_successful_transmissions, probability_channel_selected = test_dqn_extended_state_space(agent, list_of_other_users)
